...
func get_current_age_as_string():
    return get_age_as_string(current_stage)
        
        
func get_age_as_string(active_stage: stage):
    if active_stage == stage.cave:
        return "cave"
    elif active_stage == stage.knight:
        return "knight"
    elif active_stage == stage.medival:
        return "medival"
    elif active_stage == stage.miltary:
        return "miltary"
    elif active_stage == stage.future:
        return "future"
